...
export const LDI_LIABILITIES_DETAILS = 'LDI Liabilities details';
...
export const LIABILITIES_FORM_LABELS_SECTION = {
    ...
    FIELD_LABELS: {
        ...
        LIABILITY_DURATION_LDI_LABEL: 'Liability (LDI) duration',
        ...
        HAVE_PAST_SLC_TO_UPLOAD_LDI_LABEL: 'Do you have a set of liability(LDI) cashflows to upload?',
        ...
        KNOW_LIABILITY_VALUE_MDT_LDI_LABEL: 'Do you have a liability(LDI) value and details of the valuation basis?',
        LIABILITY_VALUE_LABEL: 'Liability value',
        LIABILITY_VALUE_LDI_LABEL: 'Liability(LDI) value',
