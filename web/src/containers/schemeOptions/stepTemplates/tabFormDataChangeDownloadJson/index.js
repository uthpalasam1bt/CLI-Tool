...
inside the tab configuration the devloper can define the formfields for each tab  by passing a Json config or function config
...
let TabFormDataDownload = props => {
    ...
    return (
        <>
            <DownloadUiTemplate
                downloadType={DOWNLOAD_FORM_DATA_ZIP_TYPE_SIMPLE_WITH_DATA_CHANGE} // specifying the component tyoe to be created
