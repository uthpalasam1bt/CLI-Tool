...
export const TEXT = 'Select activate to update the advisory fee for this scheme'; //The text that use to display in default scheme activation
export const FORM_TITLE = 'Default active mandate'; // Text for title to display in the header
