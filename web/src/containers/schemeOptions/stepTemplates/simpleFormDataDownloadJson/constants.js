...
export const FORM_NAME = 'SAMPLE_FORM_TWO'; // name for the form
export const FORM_TITLE = 'Simple form data download using json config'; // a title to display in the template header component
...
export const DOWNLOAD_ZIP_NAME = 'SimpleJsonFormData'; // name to the downloading zip file
export const EXCEL_TAB_NAME = 'form-data-json'; // name to the excel sheet tab that you downloaded
