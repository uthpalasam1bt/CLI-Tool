/* 
This step template can be used to create a single page form data download component using json config (simple form ) which contains form  fields
...
const { DOWNLOAD_FORM_DATA_ZIP_TYPE_SIMPLE, BUTTON_TITLE_CONTINUE } = constants; // constants that are commonly used in all other components
...
export default SimpleFormDataDownload;
