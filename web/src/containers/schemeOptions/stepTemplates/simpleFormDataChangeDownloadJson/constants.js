/* 
this file contains all the constants that are used in this simple form data download template creation using JSON config
*/

import React from 'react';

export const FORM_NAME = 'SAMPLE_FORM_SIX'; // name for the form
export const FORM_TITLE = 'Simple form data change download using json config'; // a title to display in the template header component
...
export const DOWNLOAD_ZIP_NAME = 'SimpleJsonFormData-change'; // name to the downloading zip file
export const EXCEL_TAB_NAME = 'form-data-change'; // name to the excel sheet tab that you downloaded
