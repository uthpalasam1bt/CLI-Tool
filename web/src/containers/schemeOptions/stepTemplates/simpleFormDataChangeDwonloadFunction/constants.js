...
export const FORM_NAME = 'SAMPLE_FORM_FIVE'; // name for the form
export const FORM_TITLE = 'download simple form data change using function config'; // a title to display in the template header component
...
export const DOWNLOAD_ZIP_NAME = 'SimpleFormDataChange'; // name to the downloading zip file
