/* 
This step template can be used to create a single page form data change download component (simple form ) which contains form  fields
...
let SimpleFormDataDownloadChange = props => {
    return (
        <>
            <DownloadUiTemplate
                downloadType={DOWNLOAD_FORM_DATA_ZIP_TYPE_SIMPLE_WITH_DATA_CHANGE} // specifying the component type to be tab form data change download
