...
export const DOWNLOAD_ZIP_NAME = 'ApproveRejectSimpleForm'; // name to the downloading zip file
export const EXCEL_TAB_NAME = 'simple-apprRej-data-function'; // name to the excel sheet tab that you downloaded
