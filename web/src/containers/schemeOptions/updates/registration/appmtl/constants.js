...
export const FORM_TITLE = 'Approve manager termination letters'; //text for title to display in the header.
export const DOC_NAME = 'ManagerTerminationLetter'; //name of the document you need to approve or reject
