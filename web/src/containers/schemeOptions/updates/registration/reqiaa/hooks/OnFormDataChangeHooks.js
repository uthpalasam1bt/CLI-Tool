...
import { FORM_NAME, IAA_FORM_SECTION } from '../constants';
        ...
        if (trusteeEntities.length > 0) {
            ...
            if (corpEntitiesWithTrustees.length > 0) {
               ...
               // let _dataset = dataset;
                ...
                // setting userpool
                _.setWith(_dataset, '[userPool][signatories][IAA][client]', corpEntitiesWithUniqueNames, Object);
                ...
                const signatoryEntities = _.get(_dataset, 'signatories.IAA.client', []);
                ...
                _.setWith(_dataset, '[signatories][IAA][client]', signatoryEntities, Object);
                ...
                if (Array.isArray(certiOfIncorpField) && certiOfIncorpField.length > 0) {
                    store.dispatch(change(FORM_NAME, `${IAA_FORM_SECTION.KEY}.certificateOfIncorporation`, null));
                }
            }
        } else {
            let _dataset = _.cloneDeep(dataset);
