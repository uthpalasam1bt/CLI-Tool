    ...
    return [
        {
            ...
            bool: true,
            label:
                props && iaaForm && iaaForm.trusteeType === USER_ROLE_INDIVIDUAL_TRUSTEE
        ...
        },
        {
            ...
            bool: true,
            label:
                iaaForm && iaaForm.trusteeType === USER_ROLE_INDIVIDUAL_TRUSTEE
            ...
            field: {
                ...
                disabled: stepCompleted || (options && options.disabledFields[`${namePrefix}.otherTrusteeFirstName`]),
                className: 'form-control',
                component: INPUT_FIELD,
        ...
        },
        {
            ...
            field: {
                ...
                disabled: stepCompleted || (options && options.disabledFields[`${namePrefix}.otherTrusteeLastName`]),
                className: 'form-control',
                component: INPUT_FIELD,
                validationModules: [{ moduleName: 'RequiredValidate', options: { message: 'Required' } }],
        ...
        ...([null, 'yes'].includes(_.get(iaaForm, `${namePrefix}.primaryTrusteeOtpYesNo`, null))
            ? [
                  {
                      type: FULL_CONTAINER,
                      bool: true,
                  ...
                  //                   props &&
                  //                   iaaForm &&
                  //                   iaaForm.newOtpNumbers[_.get(iaaForm, `${namePrefix}.otherTrusteeEmail`, null)]
                  //                       ? 'highlight-input-row'
                  //                       : null
                  //               }`}
                  //           >
        ...
        {
            type: ROW,
            bool: props && iaaForm && iaaForm.trusteeType === TrusteeTypes.CORPORATE_TRUSTEE,
...
const TrusteeForm = props => {
    ...
    return [
        ...
        {
            type: FULL_CONTAINER,
            bool: props && iaaForm && iaaForm.trusteeType !== TrusteeTypes.INDIVIDUAL_TRUSTEE,
        ...
        // {
        //     type: FULL_CONTAINER,
        //     bool: iaaForm && iaaForm.trusteeType === TrusteeTypes.INDIVIDUAL_TRUSTEE,
                    ...
                    childComponents: [
                                ...
                                <div className="input-row">
                                    <div className="label-wrapper">
                                        <label className="input-title active-heading font-weight-bold text-dark">
                                            ...
                                            {props &&
                                            iaaForm &&
                                            iaaForm.trusteeType === TrusteeTypes.CORPORATE_TRUSTEE ? (
                        ...
                        },
                        {
                            ...
                            field: {
                                __order: 'k',
                                disabled:
                                    stepCompleted || (options && options.disabledFields['primaryTrusteeFirstName']),
                        ...
                        },
                        {
                            ...
                            field: {
                                ...
                                disabled:
                                    stepCompleted || (options && options.disabledFields['primaryTrusteeLastName']),
                                className: 'form-control',
                                component: INPUT_FIELD,
                                validationModules: [
                                    { moduleName: 'RequiredValidate', options: { message: 'Required' } }
                        ...
                        ...([null, 'yes'].includes(_.get(iaaForm, `primaryTrusteeOtpYesNo`, null))
                            ? [
                                  {
                                      type: FULL_CONTAINER,
                                      bool: true,
        ...
        (props && iaaForm && iaaForm.trusteeType === USER_ROLE_INDIVIDUAL_TRUSTEE && iaaForm['numberOfTrustees'] > 1) ||
        (props && iaaForm && iaaForm.trusteeType !== USER_ROLE_INDIVIDUAL_TRUSTEE)
            ? {
                  type: ADD_MORE_CONTAINER,
                  bool:
                      (iaaForm &&
                          iaaForm.trusteeType === USER_ROLE_INDIVIDUAL_TRUSTEE &&
                          iaaForm['numberOfTrustees'] > 1) ||
                      (iaaForm && iaaForm.trusteeType !== USER_ROLE_INDIVIDUAL_TRUSTEE),
                  title:
                      iaaForm && iaaForm.trusteeType === USER_ROLE_INDIVIDUAL_TRUSTEE
                ...
                //   titleClass: 'pb-0',
                  ...
                  border: true,
                  maxLimit:
                      iaaForm.trusteeType === USER_ROLE_INDIVIDUAL_TRUSTEE ? iaaForm['numberOfTrustees'] - 1 : 100,
                  repeatTimes: 0,
                  divider: true,
