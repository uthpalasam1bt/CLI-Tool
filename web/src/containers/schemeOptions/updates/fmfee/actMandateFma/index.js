...
import { TEXT, FORM_TITLE, FORM_I_ICON, ON_SUBMIT_MESSAGE } from './constants';
        ...
        <>
            <CreateActivateSection
                ...
                options={{
                    ...
                    onSubmitMessage: ON_SUBMIT_MESSAGE, //Use to add a message when click on activate button
