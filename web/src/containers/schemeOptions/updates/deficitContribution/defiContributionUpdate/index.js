...
import { FORM_NAME, FORM_TITLE, FORM_I_ICON, FUNDING_FORM_SECTION, ON_SUBMIT_MESSAGE } from './constants';
...
const { WANT_US_TO_MODEL_DC } = FUNDING_FORM_SECTION.FIELD_KEYS;

let SimpleForm = props => {
    const formValues = useSelector(getFormValues(FORM_NAME));
    let optnVal = _.get(formValues, WANT_US_TO_MODEL_DC);
    return (
        <>
            <FormTemplate
