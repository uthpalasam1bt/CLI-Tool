...
const { GENERATOR_TYPE_WITH_TABS } = constants; // button constants and the component type
...

        {
            ...
            component: (
                <PickUsersTemplate
                    ...
                    alias={'clientTeam'} // alias can be 'admin / client / clientTeam'. Required only if userType is 'signatories.
                    {...props}
                />
            )
        },
