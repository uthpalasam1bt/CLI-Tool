...
import { FORM_TITLE, FORM_I_ICON, FORM_NAME, DOC_NAME } from './constants';
import constants from '../../../../workflows/constants';
import { STEP_ACTION_AUTHORIZE_MANDATE } from '../../../../workflows/constants/workflowConstant';
    ...
    return (
        <>
            <ApproveRejectContainer
                ...
                submitAction={STEP_ACTION_AUTHORIZE_MANDATE}
                downloadOptions={{
