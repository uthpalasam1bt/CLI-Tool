...
import { FORM_NAME, FORM_TITLE, FORM_I_ICON, ON_SUBMIT_MESSAGE_FIRST_STEP } from './constants';
        ...
        <>
            <FormTemplate
                ...
                options={{
                    ...
                    submitButton: {
                        //Display name of the submit button
                        title: BUTTON_TITLE_SUBMIT
                    },
                    onSubmitMessage: ON_SUBMIT_MESSAGE_FIRST_STEP, //Use to add message that display when submit form data
