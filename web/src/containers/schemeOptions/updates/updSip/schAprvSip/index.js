...
import { FORM_TITLE, FORM_I_ICON, DOC_NAME, CONTINUED_MESSAGE } from './constants';
        ...
        <>
            <ApproveRejectContainer
                ...
                options={{
                    ...
                    onSubmitMessage: CONTINUED_MESSAGE //message to display after approving the document
                }}
                downloadOptions={{
