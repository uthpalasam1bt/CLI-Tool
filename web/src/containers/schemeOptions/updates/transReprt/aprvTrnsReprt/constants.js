...
export const FORM_TITLE = 'Approve bespoke report'; //text for title to display in the header.

export const DOC_NAME = 'TransitionReport'; //name of the document you need to approve or reject
