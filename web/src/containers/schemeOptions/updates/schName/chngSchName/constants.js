...
export const FORM_TITLE = 'Input scheme name';
...
export const FORM_I_ICON = (
    <p>
        ...
        agreements. Please provide us with the formal scheme information and documents requested below. Once you have
        submitted the required information, we will review it and provide updated legal documents.
    </p>
);
export const FORM_NAME = 'SchemeForData';
