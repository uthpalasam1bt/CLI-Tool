...
import { BUTTON_TITLE_APPROVE, BUTTON_TITLE_REJECT } from '../../../../workflows/constants/workflowConstant';

const { APPROVE_REJECT_TYPE_SIMPLE, ON_APPROVE_MESSAGE, ON_REJECT_MESSAGE } = constants;

let SchemeApproveSIP = props => {
    return (
        <>
...
export default SchemeApproveSIP;
