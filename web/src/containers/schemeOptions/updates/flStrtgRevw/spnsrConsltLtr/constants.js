...
export const FORM_TITLE = 'Confirm $spscst$'; // Text for title to display in the header
...
export const FORM_I_ICON = (
    <p>Please confirm that the sponsor has been consulted regarding the change in investment strategy and updated Statement of Investment Principles.</p>
);
