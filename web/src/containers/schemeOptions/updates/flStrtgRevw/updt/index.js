...
import { FORM_NAME, FORM_TITLE, FORM_I_ICON, STRETOGY_UPDATE_FORM_SECTION, TABTWO, PICKER_TITLE, ON_SUBMIT_MESSAGE } from './constants';
    ...
    const formTabs = [
        {
            ...
            tabKey: STRETOGY_UPDATE_FORM_SECTION.KEY, //A unique key for each tab
            tabName: STRETOGY_UPDATE_FORM_SECTION.NAME, //Tab header display name
