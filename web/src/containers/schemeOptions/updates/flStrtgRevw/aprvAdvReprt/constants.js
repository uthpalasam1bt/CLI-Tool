...
export const FORM_TITLE = 'Approve $advrpt$ Report '; //text for title to display in the header.

export const DOC_NAME = 'AdvisoryReport'; //name of the document you need to approve or reject
