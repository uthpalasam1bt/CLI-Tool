...
import {
    ...
    DOWNLOAD_ZIP_NAME,
    EXCEL_TAB_NAME,
    ON_SUBMIT_AVC_INFORMATION_SECOND
} from './constants'; //constants that are  used in this component creation
        ...
        <>
            <DownloadUiTemplate
                ...
                options={{
                    ...
                    onSubmitMessage: ON_SUBMIT_AVC_INFORMATION_SECOND,
                    labelOverRide: {},
                    ...
                    attachmentArray: [],
                    excelFileName: DOWNLOAD_ZIP_NAME,
                }}
                downloadOptions={{
                    api: connectApi
                }}
