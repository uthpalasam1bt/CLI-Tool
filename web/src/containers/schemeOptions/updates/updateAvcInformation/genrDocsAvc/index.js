...
import { FORM_NAME, FORM_TITLE, SUBMITTED_MESSAGE, SAVED_MESSAGE, CONTINUED_MESSAGE } from './constants'; // constants that are used in this template
    ...
    return (
        <CreateDocumentGeneration
            ...
            options={{
                ...
                onSubmitMessage: CONTINUED_MESSAGE, // a message to be displyed if the submittion successfully completed
