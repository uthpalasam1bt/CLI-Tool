...
export const FORM_NAME = 'SAMPLE_FORM'; //Name for redux form
export const FORM_TITLE = 'Sign Investment Management Agreement'; // Text for title to display in the header
