...
import { FORM_NAME, FORM_TITLE, FORM_I_ICON, LIABILITY_UPDATE_FORM_SECTION, TABTWO, PICKER_TITLE, ON_SUBMIT_MESSAGE } from './constants';
    ...
    const formTabs = [
        {
            ...
            tabKey: LIABILITY_UPDATE_FORM_SECTION.KEY, //A unique key for each tab
            tabName: LIABILITY_UPDATE_FORM_SECTION.NAME, //Tab header display name
