...
import { FORM_NAME, FORM_TITLE, FORM_I_ICON, SUBMITTED_MESSAGE, SAVED_MESSAGE } from './constants'; // constants that are used in this template

const { GENERATOR_TYPE_SINGLE_PAGE, BUTTON_TITLE_SAVE, BUTTON_TITLE_CONTINUE } = constants; // constants that are commonly used in all other components
