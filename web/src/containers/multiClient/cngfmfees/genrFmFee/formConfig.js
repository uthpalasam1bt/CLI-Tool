    ...
    return [
        {
            type: FULL_CONTAINER,
            bool: true,
            label: FORM_FIELD_LABELS.GENERATE_FMA,
            field: {
                __order: 'a',
                name: FORM_FIELD_NAMES.GENERATE_FMA,
        ...
        },
        {
            type: FULL_CONTAINER,
            bool: true,
            label: FORM_FIELD_LABELS.EFFECTIVE_DATE,
            field: {
                __order: 'i',
                name: FORM_FIELD_NAMES.EFFECTIVE_DATE,
                className: 'form-control',
                component: DATE_PICKER,
                validationModules: [{ moduleName: 'RequiredValidate' ,options:{message:"Required"}}]
            }
        },
        ...(props[FORM_FIELD_NAMES.GENERATE_FMA]
            ? [
                  {
                      type: ROW,
                      rawComponents: (
                          <div className="doc-preview-container">
                              <div>
                                  <PDFViewer documentURL={props[FORM_FIELD_NAMES.GENERATE_FMA]} />
                              </div>
                          </div>
                      )
                  }
